            ...
            ?>
                <div class="memorial-card">
                    ...
                    <div class="memorial-info">
                        ...
                        <form action="https://memorialmap.duckdns.org/memorial.php?id=<?php echo htmlspecialchars($memorial['Memorial_MapID']); ?>"><input type="submit" value="View Memorial" /></form>
                    </div>
                </div>
            <?php 
                endforeach; 
